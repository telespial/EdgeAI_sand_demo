...
## Last Run
- Date: 2026-02-08
- Result: build + flash ok; LCD shows shaded "silver ball" with trails, responds to tilt
- Binary: `mcuxsdk_ws/build/edgeai_sand_demo_cm33_core0.bin` (or `mcuxsdk_ws_test/build/...`)
- Notes:
  - NPU path enabled: TFLM + Neutron backend; output modulates specular glint (see `src/edgeai_sand_demo.c`)
